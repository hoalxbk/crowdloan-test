    ...
    <div class="ranking-container">
      <div class="ranking-item border-right border-bottom"><h3 class="info-title">Total point:</h3>
        <h3 class="info-value">
          ...
          <span v-else>
          <span>{{ !profile.totalPoint ? 0 : profile.totalPoint.toFixed(2).toLocaleString("us-US", {minimumFractionDigits: 1}) }}</span>
          </span>
        </h3>
      </div>
      <div class="ranking-item border-right border-bottom"><h3 class="info-title">Early Bird Point:</h3>
        <h3 class="info-value">
          <img v-if="isLoadingProfile" src="../assets/polkasmith/Loading.gif" width="25" height="25"/>
          <span v-else>
          <span>{{ !profile.earlyPoint ? 0 : profile.earlyPoint.toFixed(2).toLocaleString("us-US", {minimumFractionDigits: 1}) }}</span>
          </span>
        </h3>
      </div>
      ...
      <div class="ranking-item border-right"><h3 class="info-title" >Referral Point:</h3>
        <h3 class="info-value">
          <img v-if="isLoadingProfile" src="../assets/polkasmith/Loading.gif" width="25" height="25"/>
          <span v-else>
          <span>{{ !profile.refPoint ? 0 : profile.refPoint.toFixed(2).toLocaleString("us-US", {minimumFractionDigits: 1}) }}</span>
      ...
      <div class="ranking-item border-right"><h3 class="info-title">Gleam Point:</h3>
        <h3 class="info-value">
          <img v-if="isLoadingProfile" src="../assets/polkasmith/Loading.gif" width="25" height="25"/>
          <span v-else>
          <span>{{ !profile.gleamPoint ? 0 : profile.gleamPoint.toFixed(2).toLocaleString("us-US", {minimumFractionDigits: 1}) }}</span>
    ...
    <div class="top-table">
      <div class="table-container">
        <div class="table-item" v-for="(item, i) in currentDataPage" :key="i">
          ...
          <div class="label-amount">{{ item.totalPoint.toFixed(2).toLocaleString("us-US", {minimumFractionDigits: 1}) }} Points</div>
        </div>
      </div>
